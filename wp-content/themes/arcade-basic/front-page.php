...
?>
	...
	<div ng-repeat="data in testData">
	{{data.firstName}}
	</div>
    <form>
    search <input id="isotopeSearch"></input>-->
        <!--title<input ng-model="post-title"></input>
        comment<input ng-model="post-comments"></input>
        <button type="submit">submit</button>-->
    <!--</form>-->

	<div id="isotope" >

	    <div  ng-repeat="post in posts" ng-class='{huge:$first}' class="{{post.tags[0].title}} id-{{post.$$hashKey}} {{post.title_plain}} item element-item col-xs-12 col-sm-6 col-md-6 col-lg-4 seen flip-container" ontouchstart="this.classList.toggle('click');">
